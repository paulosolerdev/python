...
if menu == 'S':
    ...
    if medico == 3:
        print(f'Sua consulta com o Dr. {medicos[2]} será agendada.')
    if medico == 4:
        print(f'Sua consulta com o Dr. {medicos[3]} será agendada.')
    if medico == 5:
        print(f'Sua consulta com o Dr. {medicos[4]} será agendada.')
